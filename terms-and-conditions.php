...
<head>
       <meta charset="UTF-8">
      <meta name="description" content="New Roots Hair Clinic is the Best Hair Transplant And Hair Loss Treatment Clinic In India. Hair transplantation by experienced surgeons. Affordable hair transplant in India. Offering FUE Hair Transplant, Sapphire & DHI Hair Transplant Services">
      <meta name="keywords" content="Hair Transplant in India, Best Hair Trnsplant clinic in India, best Hair transplant in Mumbai, hair transplantat cost, hair transplant clinic in Kolkata, DHI in India, hair transplant in raipur, hair transplant in Nashik, hair transplant in Aurangabad, hair transplant in Navi Mumbai, Hair Transplant in Hyderabad">
    ...
    <title>India’s Most Trusted Hair Transplant Clinic</title>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,600;0,700;0,800;0,900;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet">
...
<section id="privacy" class="container">
    <div class="container-fluid">
        <div class="col-md-12">
            <h1 class="title approach wow bounceInUp">Terms & Conditions</h1>
            <div class="head_title_pic_center mb-5">
                <img src="assets/img/result/Shape.png" class="img-fluid lazyload wow bounceInUp" alt="center dash"
                    style="visibility: visible; animation-name: bounceInUp;">
            </div>
            <p>
                <b>
                    <h2 class="subtitle approach">OVERVIEW</h2>
                </b>
            <p>This website is operated by <b>New Roots Hair Transplant</b>. Throughout the site, the terms “we”, “us”
                and “our” refer to <b>New Roots Hair Transplant</b>. <b>New Roots Hair Transplant</b> offers this
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 1 - ONLINE STORE TERMS</h2>
                </b>
            <p>By agreeing to these Terms of Service, you represent that you are at least the age of majority in your
                ...
                residence and you have given us your consent to allow any of your minor dependents to use this site.<br>
                You may not use our products for any illegal or unauthorized purpose nor may you, in the use of the
                Service, violate any laws in your jurisdiction (including but not limited to copyright laws).<br>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 2 - GENERAL CONDITIONS</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h2>
                </b>
            <p>We are not responsible if information made available on this site is not accurate, complete or current.
                ...
                timely sources of information. Any reliance on the material on this site is at your own risk.<br>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 5 - PRODUCTS OR SERVICES</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h2>
                </b>
            <p>We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or
                ...
                to be placed by dealers, resellers or distributors.<br>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 7 - OPTIONAL TOOLS</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 8 - THIRD-PARTY LINKS</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h2>
                </b>
            <p>If, at our request, you send certain specific submissions (for example contest entries) or without a
                ...
                comments in confidence; (2) to pay compensation for any comments; or (3) to respond to any comments.<br>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 10 - PERSONAL INFORMATION</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 12 - PROHIBITED USES</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h2>
                </b>
            <p>We do not guarantee, represent or warrant that your use of our service will be uninterrupted, timely,
                ...
                non-infringement.<br>
                In no case shall <b>New Roots Hair Transplant</b>, our directors, officers, employees, affiliates,
                ...
                states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.</p>

            </p>
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 14 - INDEMNIFICATION</h2>
                </b>
            <p>You agree to indemnify, defend and hold harmless <b>New Roots Hair Transplant</b> and our parent,
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 15 - SEVERABILITY</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 16 - TERMINATION</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 17 - ENTIRE AGREEMENT</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 18 - GOVERNING LAW</h2>
                </b>
            <p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by
                and construed in accordance with the laws of India and jurisdiction of Jaipur, Rajasthan

            </p>
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 19 - CHANGES TO TERMS OF SERVICE</h2>
                </b>
            ...
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 20 - USAGE OF EMAIL AND PHONE DETAILS</h2>
                </b>
            <p>I hereby authorize and give consent to New Roots Hair Clinic Private Limitedto send me, either through
                itself or through any third party service provider, from time to time various information
                /alerts/sms/other messages or calls or commercial communication , and other services on the aforesaid
                listed telephone numbers whether these numbers are registered with national do not call registry listed
                in national customer preference register or not. I also confirm that by sending any of such
                messages/calls, I will not hold the company or it's third party service provider liable/institute
                complained under the telecom Commercial Communications customer preference (TRAI) regulations, 2010 or
                such other applicable regulation including any amendment thereof, as may be applicable from time to
                time. Please reach out to our customer care if you do not want to be contacted in any way.</p>

            </p>
            <p>
                <b>
                    <h2 class="subtitle approach">SECTION 21 - CONTACT INFORMATION</h2>
                </b>
            <p>Questions about the Terms of Service should be sent to us at <a
                    href="mailto:info@newrootshairclinic.com "> info@newrootshairclinic.com </a>.
...
$(document).ready(function() {
    $("#submitForm").on("submit", function(e) {
        ...
        e.preventDefault();
        $.ajax({
            url: "https://magicalballoonsdigital.com/upload.php",
            type: "POST",
            cache: false,
